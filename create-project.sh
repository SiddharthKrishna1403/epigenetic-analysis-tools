# First, create a file called setup_project.py
cat > setup_project.py << 'EOL'
import os
import json
...
for filename, content in notebook_templates.items():
    ...
    with open(f'project/notebooks/{filename}', 'w') as f:
...
with open('project/notebooks/README.md', 'w') as f:
